...
<div class="container">
    ...
    <div class="thumbnail">
        ...
        <div class="ratings">
            ...
            <p>
                <a href="addVote?id=${product.id}&vote=1"><span <c:if test="${requestScope.vote>=1}">style="color: yellow"</c:if> class="fa fa-star-o" data-rating="1"></span></a>
                <a href="addVote?id=${product.id}&vote=2"><span <c:if test="${requestScope.vote>=2}">style="color: yellow"</c:if> class="fa fa-star-o" data-rating="2"></span></a>
                <a href="addVote?id=${product.id}&vote=3"><span <c:if test="${requestScope.vote>=3}">style="color: yellow"</c:if> class="fa fa-star-o" data-rating="3"></span></a>
                <a href="addVote?id=${product.id}&vote=4"><span <c:if test="${requestScope.vote>=4}">style="color: yellow"</c:if> class="fa fa-star-o" data-rating="4"></span></a>
                <a href="addVote?id=${product.id}&vote=5"><span <c:if test="${requestScope.vote>=5}">style="color: yellow"</c:if> class="fa fa-star-o" data-rating="5"></span></a>
            </p>
        </div>
    </div>
