...
public abstract class Parameters{
    ...
    public static final String USER_REPASSWORD = "repassword";
    ...
    public static final String CATEGORS = "categors";
    public static final String PRODUCT_PARAMS = "productParams";
